...
from krzycz_trybson.speach_to_text.speech_to_text_assemblyAI import (
    AssemblyAITranscriber,
)
from krzycz_trybson.speach_to_text.speech_to_text_whisper import WhisperTranscriber
